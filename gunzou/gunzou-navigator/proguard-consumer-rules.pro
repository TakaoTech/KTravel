# Consumer ProGuard/R8 rules for the :gunzou-navigator module.
#
...
# The contract DTOs are kept by :gunzou-navigator-api's own consumer rules. What is left here is the
