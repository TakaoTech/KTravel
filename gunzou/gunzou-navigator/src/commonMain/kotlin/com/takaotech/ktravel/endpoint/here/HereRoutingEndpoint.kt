 ...
 * client afterwards. Without it, both would be a `NavigationEndpoint<HereRoutingCall>`, which erases to
 * the same class and cannot be told apart by a container that keys on it.
 *
 ...
 */
interface HereRoutingEndpoint : NavigationEndpoint<HereRoutingCall> {
