 ...
 *
 * The descriptor comes from [NavigatorProfile.HereCar] rather than being declared here: what the
...
interface HereCarEndpoint : NavigationEndpoint<HereCarRouteRequest> {
    override val descriptor: ProviderProfileDescriptor get() = NavigatorProfile.HereCar.descriptor
}
