# Consumer ProGuard/R8 rules for the :gunzou-navigator-client module.
#
...
#
# The contract types themselves are kept by :gunzou-navigator-api's own consumer rules; what is left
