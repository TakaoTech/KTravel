package com.takaotech.navigation

import com.takaotech.navigation.common.HereClientConfig
import com.takaotech.navigation.common.createHereHttpClient
import com.takaotech.navigation.common.withHereDefaults
import com.takaotech.navigation.publictransit.client.HereTransitApi
import com.takaotech.navigation.routing.client.HereRoutingApi
...
class HereClient private constructor(private val httpClient: HttpClient, val config: HereClientConfig) : AutoCloseable {
    ...
    val publicTransit: HereTransitApi by lazy { HereTransitApi(httpClient, config.publicTransitBaseUrl) }
