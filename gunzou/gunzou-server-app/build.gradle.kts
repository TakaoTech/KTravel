...
// Deployment entry point for :gunzou-server. It exists as a separate module because the Ktor
...
dependencies {
    ...
    // :gunzou-server declares Ktor as implementation, so the engine is on the runtime classpath
