# Consumer ProGuard/R8 rules for the :gunzou-navigator-api module.
#
...
-keepclassmembers class com.takaotech.navigator.api.** {
    *** Companion;
    *** INSTANCE;
    kotlinx.serialization.KSerializer serializer(...);
}
-keep,includedescriptorclasses class com.takaotech.navigator.api.**$$serializer { *; }
...
-keep class com.takaotech.navigator.api.common.RouteTime { *; }
-keep class com.takaotech.navigator.api.common.RouteTime$* { *; }
