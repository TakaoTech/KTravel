...
class TravelListViewModelTest : BehaviorSpec() {
    init {
        ...
        given("a TravelListViewModel when repository returns an empty list") {
            everySuspend { mockRepository.getAllTravelPlans() } returns emptyList()
            val viewModel = TravelListViewModel(mockRepository, mockImporter, planningGraphStore)
        ...
        given("a TravelListViewModel when repository returns a single travel plan") {
        ...
        given("a TravelListViewModel when repository returns multiple travel plans") {
        ...
        given("a TravelListViewModel when repository throws an exception") {
        ...
        given("a TravelListViewModel after initial load with two plans") {
            everySuspend { mockRepository.getAllTravelPlans() } returns listOf(
                samplePlan1,
                samplePlan2,
            )
        ...
        given("a TravelListViewModel not in selection mode") {
            ...
            val viewModel = TravelListViewModel(repository, mockImporter, planningGraphStore)
            viewModel.loadTravelPlans()
        ...
        given("a TravelListViewModel in selection mode") {
            val repository: TravelManagerRepository = mock()
            everySuspend { repository.getAllTravelPlans() } returns listOf(samplePlan1, samplePlan2)
            val viewModel = TravelListViewModel(repository, mockImporter, planningGraphStore)
            viewModel.loadTravelPlans()
        ...
        given("a TravelListViewModel with two loaded plans") {
            val repository: TravelManagerRepository = mock()
            everySuspend { repository.getAllTravelPlans() } returns listOf(samplePlan1, samplePlan2)
        ...
        given("a TravelListViewModel with three selected plans") {
            val repository: TravelManagerRepository = mock()
        ...
        given("a TravelListViewModel whose repository fails to delete") {
            val repository: TravelManagerRepository = mock()
            everySuspend { repository.getAllTravelPlans() } returns listOf(samplePlan1, samplePlan2)
