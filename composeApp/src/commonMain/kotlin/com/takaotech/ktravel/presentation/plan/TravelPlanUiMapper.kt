...
object TravelPlanUiMapper {
    ...
    fun TravelPlanDomain.toUiState(): PlanOverviewUiState = PlanOverviewUiState(
     ...
     * as derived flags, so this cannot rebuild them and returns a place with none. Never put it on
     * a path that saves an existing place, or it would wipe what that place holds.
     */
