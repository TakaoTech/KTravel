...
/**
 * The options of a transit profile: which vehicles are acceptable, and how the journey may be
 * shaped.
 *
 * No per-vehicle extras screen, unlike the routing family, and the asymmetry is the point: there is
 * no chosen vehicle here to hang a rule on. The modes restrict what the answer may use, and the
 * rest of the options — transfers, walking — apply to the journey as a whole.
 *
