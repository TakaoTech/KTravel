 ...
 * types themselves: the screen is persisted with the back stack, and serialising it must not force
 * the routing model to carry serialization annotations of its own. [spec] puts the domain shape
 * back for the presenter, recomputed from those fields rather than stored.
 *
