 ...
 *
 * Separate from [RoutingRouteOptionsScreen] because the answer to "which controls apply" changes
 * with the vehicle and not with the profile: a car is asked about tolls and motorways, a scooter
 * about neither, a pedestrian about nothing at all. Keying a screen on the vehicle is what lets a
 * new one arrive with its own controls without the family's block knowing.
 *
 ...
 * @property tollsUnsupported Whether tolls are missing from the list because the profile declares
 *   it
