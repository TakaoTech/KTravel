 ...
 *
 * Writes to the same draft as [RoutingRouteOptionsPresenter] and never seeds it: by the time this
 * block is composed the family above has already put a request there. Nor does it ever touch the
 * vehicle — so a click landing in the frame where the vehicle is changing still applies to the
 * current request rather than reviving the previous one.
 */
