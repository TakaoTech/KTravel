 ...
 * does not, which is what lets a segmented button be selected without the screen having to invent an
 ...
 *
 * Rounded *up* rather than to the nearest, so the hour offered is never one that has already passed.
 */
