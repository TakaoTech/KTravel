...
object TravelPlanEditor {
    ...
    fun TravelPlanDomain.savePlace(place: PlaceDomain, dayId: String?): TravelPlanDomain = if (dayId == null) {
        copy(places = places + place)
    } else {
        updateDay(dayId) { it.copy(places = it.places + place) }
    }

    fun TravelPlanDomain.updateStep(dayId: String, stepId: String, updatedStep: StepDomain): TravelPlanDomain =
        updateDay(dayId) { day ->
     ...
     */
    fun TravelPlanDomain.updatePlaceStartTime(dayId: String, stepId: String, time: LocalTime): TravelPlanDomain =
     ...
     */
    fun TravelPlanDomain.updatePlaceEndTime(dayId: String, stepId: String, time: LocalTime): TravelPlanDomain =
    ...
    fun TravelPlanDomain.movePlaceToStep(placeId: String, dayId: String): TravelPlanDomain = updateDay(dayId) { day ->
    ...
    fun TravelPlanDomain.moveStepToPlace(stepId: String, dayId: String): TravelPlanDomain = updateDay(dayId) { day ->
    ...
    fun TravelPlanDomain.moveStepUp(stepId: String, dayId: String): TravelPlanDomain = updateDay(dayId) { day ->
    ...
    fun TravelPlanDomain.moveStepDown(stepId: String, dayId: String): TravelPlanDomain = updateDay(dayId) { day ->
        val index = day.steps.indexOfFirst { it.id == stepId }
    ...
    fun TravelPlanDomain.deletePlace(placeId: String, dayId: String?): TravelPlanDomain = if (dayId == null) {
