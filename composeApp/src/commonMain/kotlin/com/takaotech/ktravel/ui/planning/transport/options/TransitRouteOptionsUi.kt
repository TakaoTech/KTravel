...
import com.takaotech.ktravel.presentation.planning.transport.options.MAX_CHANGES_LIMIT
import com.takaotech.ktravel.presentation.planning.transport.options.TransitRouteOptionsEvent
import com.takaotech.ktravel.presentation.planning.transport.options.TransitRouteOptionsScreen
import com.takaotech.ktravel.presentation.planning.transport.options.TransitRouteOptionsUiState
import com.takaotech.ktravel.presentation.planning.transport.options.WALK_DISTANCE_DEFAULT
import com.takaotech.ktravel.presentation.planning.transport.options.WALK_DISTANCE_MAX
import com.takaotech.ktravel.presentation.planning.transport.options.WALK_DISTANCE_MIN
import com.takaotech.ktravel.presentation.planning.transport.options.WALK_DISTANCE_STEP
...
internal fun TransitRouteOptionsContent(
    ...
    Column(modifier = modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(22.dp)) {
        ...
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            // having asked at all.
            LimitedNumber(
                testTag = PlanningTransportTestTags.CHANGES_LIMIT,
                sliderTestTag = PlanningTransportTestTags.CHANGES_SLIDER,
            ...
            LimitedNumber(
                testTag = PlanningTransportTestTags.WALK_DISTANCE_LIMIT,
                sliderTestTag = PlanningTransportTestTags.WALK_DISTANCE_SLIDER,
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun WalkingPaceSelector(
    pace: WalkingPace,
    ...
    Column(modifier = modifier) {
        ...
        SingleChoiceSegmentedButtonRow(modifier = Modifier.fillMaxWidth()) {
            WalkingPace.entries.forEachIndexed { index, entry ->
                SegmentedButton(
                    modifier = Modifier.testTag(PlanningTransportTestTags.walkingPaceTag(entry.name)),
                    selected = entry == pace,
