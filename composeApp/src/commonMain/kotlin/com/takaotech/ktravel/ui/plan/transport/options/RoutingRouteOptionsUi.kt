...
import com.takaotech.ktravel.presentation.plan.transport.options.RoutingRouteOptionsEvent
import com.takaotech.ktravel.presentation.plan.transport.options.RoutingRouteOptionsScreen
import com.takaotech.ktravel.presentation.plan.transport.options.RoutingRouteOptionsUiState
 ...
 *
 * Draws what does not depend on the vehicle and lets the vehicle draw the rest:
 * [RoutingModeExtrasUi] arrives through a nested `CircuitContent`, so a vehicle that grows its own
 * controls reaches this screen without this file changing.
 */
