...
internal object ImportSecretsDialogTestTags {
    ...
    const val PASSWORD = "import_secrets_password"
    const val PASSWORD_CONFIRM = "import_secrets_password_confirm"
    const val PASSWORD_CANCEL = "import_secrets_password_cancel"
}
