 ...
 * from — a journey has no manoeuvres, so it rendered as a column of empty headings. What a traveller
 * needs is the shape of the itinerary: how long it takes door to door, how many times they change,
 * and for each step the line, the direction and the two times that matter.
 */
@Composable
